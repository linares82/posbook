...
<a-row>
    <a-col :span="12">
        <a-page-header style="border: 1px solid rgb(235, 237, 240)" title="Caja" sub-title="Cajas Con Apartados" />
    </a-col>
    <a-col :span="12">
    ...
    <a-row>
        ...
        <a-col :md="7">
            <a-form-item compact label="Fecha de:" name="fecha_f" :rules="[{ required: true, message: 'Por favor captura la información solicitada!' }]">
                <a-date-picker v-model:value="formCashBox.fecha_f" :bordered="true" />
        ...
        <a-col :md="7">
            <a-form-item compact label="Fecha a:" name="fecha_t" :rules="[{ required: true, message: 'Por favor captura la información solicitada!' }]">
                <a-date-picker v-model:value="formCashBox.fecha_t" :bordered="true" />
