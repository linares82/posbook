    ...
    <a-row :gutter="20">
        ...
        <a-col :md="7">
            <a-form-item compact label="Plantel" name="plantel_id" :rules="[{ required: true, message: 'Por favor captura la información solicitada!' }]">
                <a-select :options="planteles" mode="multiple" show-search v-model:value="formCashBox.plantel_id" style="width: 100%" placeholder="Seleccionar Opción" :filter-option="filterOption">
                </a-select>
        ...
        <a-col :md="7">
            <a-form-item compact label="Productos" name="producto_id" :rules="[{ required: true, message: 'Por favor captura la información solicitada!' }]">
                <a-select :options="productos" mode="multiple" show-search v-model:value="formCashBox.producto_id" style="width: 100%" placeholder="Seleccionar Opción" :filter-option="filterOption">
                </a-select>
                <div v-if="errors.producto_id">
                    <div role="alert" class="ant-form-item-explain-error" style="" v-text="errors.producto_id"></div>
                </div>
            </a-form-item>
        </a-col>
    </a-row>
...
export default {
    ...
    props: ["errors", "planteles", "productos"],
    ...
    setup(props) {
        ...
        let submitF = () => {
            Inertia.post("/movements/movimientosEntradasConsumosR", formCashBox, {
                onStart: () => {
