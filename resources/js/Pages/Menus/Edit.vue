<template>
  <a-row>
    <a-col :span="12">
      <a-page-header style="border: 1px solid rgb(235, 237, 240)" title="Menus" sub-title="Editar" />
    </a-col>
    <a-col :span="12">
      <Link href="/menus" class="ant-btn ant-btn-primary ant-btn-round ant-btn-sm" as="button">Regresar</Link>
    </a-col>
  </a-row>
  <a-form :model="formMenu" @submit.prevent="submitF" autocomplete="off" layout="vertical">
    <a-row>
      <a-col :md="7">
      ...
      <a-col :md="7">
        <a-form-item label="Orden" name="orden">
          ...
          <div v-if="errors.orden">
            <div role="alert" class="ant-form-item-explain-error" style="" v-text="errors.orden"></div>
          </div>
        </a-form-item>
      </a-col>
      ...
      <a-col :md="7">
        <a-form-item label="Depende de" name="depende_de">
          ...
          <div v-if="errors.depende_de">
            <div role="alert" class="ant-form-item-explain-error" style="" v-text="errors.depende_de"></div>
          </div>
        </a-form-item>
      </a-col>
      ...
      <a-col :md="7">
        <a-form-item label="Link" name="link">
          ...
          <div v-if="errors.link">
            <div role="alert" class="ant-form-item-explain-error" style="" v-text="errors.link"></div>
          </div>
        </a-form-item>
      </a-col>
      ...
      <a-col :md="7">
        <a-form-item label="Permiso" name="permiso">
          ...
          <div v-if="errors.permiso">
            <div role="alert" class="ant-form-item-explain-error" style="" v-text="errors.permiso"></div>
          </div>
        </a-form-item>
      </a-col>
      ...
      <a-col :md="7">
        <a-form-item label="Target" name="target">
          ...
          <div v-if="errors.target">
            <div role="alert" class="ant-form-item-explain-error" style="" v-text="errors.target"></div>
          </div>
        </a-form-item>
      </a-col>
      ...
      <a-col :md="7">
        <a-form-item label="Imagen" name="imagen">
          ...
          <div v-if="errors.imagen">
            <div role="alert" class="ant-form-item-explain-error" style="" v-text="errors.imagen"></div>
          </div>
        </a-form-item>
      </a-col>
...
export default {
  ...
  setup(props) {
    let formMenu = reactive({
      id: props.menu.id,
      item: props.menu.item,
      orden: props.menu.orden,
      depende_de: props.menu.depende_de,
      link: props.menu.link,
      permiso: props.menu.permiso,
      target: props.menu.target,
      imagen: props.menu.imagen
    });

    let processing = ref(false);

    let submitF = () => {
      Inertia.post("", formMenu, {
        onStart: () => {
