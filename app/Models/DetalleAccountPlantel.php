...
class DetalleAccountPlantel extends Model
{
    use HasFactory, SoftDeletes;
    protected $table="detalle_account_plantel";
    ...
    protected $fillable = ['account_plantel_id', 'ln_cash_box_id', 'expense_id','monto_ingreso',
    'monto_egreso', 'saldo_ingresos', 'saldo_egresos',
